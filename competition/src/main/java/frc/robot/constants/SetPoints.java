...
public class SetPoints {
    ...
    public final static Rotation2d SHOULDER_FRONT_HP_ANLGE = new Rotation2d(Units.degreesToRadians(77));
    public final static Rotation2d SHOULDER_BACK_HP_ANLGE = new Rotation2d(Units.degreesToRadians(-77));
