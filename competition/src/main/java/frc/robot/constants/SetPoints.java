...
public class SetPoints {
    ...
    public final static Rotation2d SHOULDER_FRONT_HP_ANGLE = new Rotation2d(Units.degreesToRadians(82));
    public final static Rotation2d SHOULDER_BACK_HP_ANGLE = new Rotation2d(Units.degreesToRadians(-82));
    ...
    public final static double TELESCOPE_FRONT_HP_LENGTH = 0;
    public final static double TELESCOPE_BACK_HP_LENGTH = 0;
    ...
    public static class ARM {
        ...
        public static final int FRONT_HP = 4;
        public static final int UP = 5;
        public static final int BACK_HP = 6;
